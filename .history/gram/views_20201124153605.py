...
def home(request):
    ...
    return render(request, 'grammies/index.html',{"images":images})
...
def image_upload(request):
    ...
    if request.method == 'POST':
        ...
        return render(request,'grammies/upload.html', {"form":form})
...
def profile_edit(request):
    ...
    if request.method == 'POST':
        ...
        return render(request,'grammies/edit.html',{"form":form})
...
def search_user(request):
    ...
    if 'search_user' in request.GET and request.GET["search_user"]:
        ...
        return render(request, 'grammies/search_results.html', {"message": message, "users": searched_user})
